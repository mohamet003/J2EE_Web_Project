                ...
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        ...
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <div class="alert alert-danger" id="alert" role="alert">La quantité saisite est Incorrecte ou Indisponible!</div>
...
// verif quantité à commender
    function verifQte(qte, qteDispo) {
        if (qte <= qteDispo && qte !== 0) {
            $("#updatepurchase").removeClass("inactiveLink");
            $("#alert").hide();
            $("#purchase").removeClass("inactiveLink");

            return true;
        }
        $("#alert").show();
        $("#purchase").addClass("inactiveLink");
        $("#updatepurchase").addClass("inactiveLink");
        return false;
    }
    ...
    $("#purchase").click(function () {
        ...
        console.log("testt " + verifQte(qte, qteDispo));
        if (verifQte(qte, qteDispo)) {
