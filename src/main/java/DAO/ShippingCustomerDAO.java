...
public class ShippingCustomerDAO {
    ...
    public ShippingCustomerDAO(DataSource myDataSource) {
     ...
     public List<ShippingForCustomer> GetCaByIDCustomer(int customerID, String dateD, String dateF) throws DAOException, ParseException {
        ...
        "WHERE CUSTOMER_ID = ? AND PURCHASE_ORDER.SALES_DATE BETWEEN ? AND ?\n" +
        "GROUP BY (SALES_DATE)";
